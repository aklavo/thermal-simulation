...
contanst_flow = st.Page("Simulation-Results/3-Constant-Flow.py", title="Constant Flow", icon=":material/pentagon:")
...
pg = st.navigation(
    {
        ...
        "Simulation Results": [no_flow_no_loss, no_flow, contanst_flow, controlled_flow],
    }
)
